    ...
    <aside className="hidden lg:block relative">
      <div className="sticky top-28 flex flex-col items-center gap-8">
        <button className="flex flex-col items-center gap-1 group">
          <div onClick={() => navigate({ to: "/" })} className="size-12 rounded-full border border-slate-200 flex items-center justify-center text-slate-500 group-hover:bg-primary group-hover:text-white group-hover:border-primary transition-all duration-300">
            <ArrowLeft size={20} />
          </div>
